import type { variant, size, color, label, error, success, resize, labelProps, className, shrink, containerProps } from "@material-tailwind/src/types/components/input";
