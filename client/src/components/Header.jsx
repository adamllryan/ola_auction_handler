  ...
  return (
    <Navbar className="relative w-full p-4 z-50 border border-slate-400">
      ...
      <div className="flex items-center justify-between text-blue-gray-900">
        ...
        <div className='text-black absolute left-1/2 z-0 text-center'>
          <label className='peer/dropdown hover:cursor-pointer p-8'>
            <FontAwesomeIcon className='group-hover/header:rotate-180 duration-300 ease-out ' icon={faChevronDown} />  
          </label>
        </div>
        <div className="border rounded-lg items-center gap-4">
          <Button
            variant="gradient"
            size="sm"
            ...
            <span className='text-black'>
              {
                ...
                <div className='inline-flex items-center justify-center content-center' role="status">
